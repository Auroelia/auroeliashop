...
function Contacto() {
  ...
  return (
    <div className='w-full h-full relative'>
        <div className='w-full h-screen md:h-[800px] lg:h-[1050px] 2xl:h-[1050px] flex flex-col items-center max-w-[1440px] min-w-sm mx-auto relative '>
        <Image
        width={100}
        height={100}
        src='/assets/petaloizq.png' alt='flores' className='w-[100px] md:w-[150px] lg:w-[221px] h-[100px] md:h-[150px] lg:h-[200px] object-cover absolute bottom-0 -left-[50px] lg:bottom-[100px] lg:-left-[0px]'/>
          <Image
          width={103}
            height={111}
          src='/assets/Home/populares/petalo.png' alt='imagen petalo' className='w-[103px] h-[111px] lg:w-[230px] lg:h-[247px] object-cover absolute lg:top-[0px] lg:-right-[0px] right-0 top-[150px]
        ...
        Dudas y comentarios
                ...
                >
                    ...
                    width={32}
                    height={32}
                    src="/assets/icons/contactPhone.svg" alt='contacto1' className='w-[32px] h-[32px] md:w-[40px] md:h-[40px] lg:w-[64px] lg:h-[62px] object-cover' />
                    </div>
                ...
                <div className='w-[50px] lg:w-[80px] h-[50px] lg:h-[80px]  flex justify-center items-center'>
                        ...
                        width={48}
                        height={31}
                        src="/assets/icons/contactMail.svg" alt='contacto1' className='w-[48px] h-[31px] md:w-[52px] md:h-[40px]  lg:w-[82px] lg:h-[61px] object-cover' />
                        </div>
                ...
                <div className='w-[50px] lg:w-[80px] h-[50px] lg:h-[80px]  flex justify-center items-center'>
                        ...
                        width={20}
                        height={32}
                        src="/assets/icons/conctactFB.svg" alt='contacto1' className='w-[20] h-[32px] md:w-[30px] md:h-[50px] lg:w-[44px] lg:h-[70px] object-cover' />
                        </div>
                        <div className='w-[100px] flex items-center'>
                ...
                <div className='w-[50px] lg:w-[80px] h-[50px] lg:h-[80px]  flex justify-center items-center'>
                        ...
                        width={32}
                        height={37}
                        src="/assets/icons/contactIG.svg" alt='contacto1' className='w-[32px] h-[37px] md:w-[40px] md:h-[50px] lg:w-[64px] lg:h-[73px] object-cover' />
                        </div>
                        <div className='w-[100px] flex items-center'>
