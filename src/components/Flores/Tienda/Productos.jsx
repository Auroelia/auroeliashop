...
function Productos({
  ...
  itemsPerPage,
  totalItems,
  filteredProductos = [], // Asegurarse de que filteredProductos sea un array por defecto
      ...
      <div>
        <div className="w-[90%] lg:w-[97%] flex flex-row items-center justify-end gap-[21px] mt-[56px] ">
          <button
            ...
            className={
              currentPage > 1
                ? `rounded-full bg-[#d8d8d8] w-[76px] h-[76px] flex items-center justify-center`
                : "hidden"
            }
          >
          ...
          <button
            ...
            className={
              currentPage < Math.ceil(totalItems / itemsPerPage)
                ? "rounded-full bg-black w-[76px] h-[76px] flex items-center justify-center"
                : "hidden"
            }
          >
