  ...
  return (
    <div className='w-full h-full overflow-hidden relative'>
      ...
      <div className='w-full h-[549px] flex flex-col lg:flex-row justify-center items-center max-w-[1440px] min-w-sm mx-auto lg:gap-[20px] xl:gap-[0px]'>
        ...
        <div className='w-full justify-center flex flex-col items-center gap-[21px]' >

        <div className='w-full justify-center flex flex-col text-white leading-[60px] text-[42px] lg:text-[56px] text-center lg:text-left'>
          <h2 className=' '>Ideas que nacen </h2>
          <h2 className=' '>del <span className='text-[#E39C9D]'>corazón</span></h2>

        </div>
        <div className='w-[430px] lg:w-full flex flex-row  justify-center lg:justify-start '>
