...
function Populares() {
  ...
  return (
    <div className="w-full h-full  relative">
      ...
      width={377}
      height={300}
      src='/assets/petaloizq.png' alt='flores' className='hidden xl:block w-[377px] h-[300px] object-cover absolute -bottom-[80px] -left-[0px]'/>
      <div className="w-full h-[650px] hidden xl:flex flex-col justify-center max-w-[1440px] min-w-sm mx-auto relative">
      <Image
      width={271}
      height={292}
      src='/assets/Home/populares/petalo.png' alt='flores' className='w-[271px] h-[292px] object-cover absolute -top-[150px] -right-[100px]'/>
